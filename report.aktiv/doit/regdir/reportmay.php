                    ...
                    <tbody>
                      ...
                      ?>
                        ...
                        <tr>
                          ...
                          <?
                          $result3 = mysqli_query($connect, " SELECT * FROM reports052020 WHERE reg_date=(SELECT MAX(reg_date) FROM reports052020 WHERE region = '$region' AND adress = '$filial' ) ");
                    ...
                    <tfoot>
                      <tr style="background: #d3d7df; color: black;">
                        ...
                        while ($data4 = mysqli_fetch_array($result4)) {
                          $filial =  $data4['adress'];
                          $result5 = mysqli_query($connect, " SELECT auktech,aukshubs,nalvzaloge FROM reports052020 WHERE reg_date=(SELECT MAX(reg_date) FROM reports052020 WHERE region = '$region' AND adress = '$filial' ) ");
