...
?>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          <?= $region; ?>/<?= $adress; ?>
          <small><a href="reportapril.php">назад к списку</a></small>
        </h1>
        <ol class="breadcrumb">
          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                <h3 class="box-title">Отчет за апрель 2020</h3>
              </div><!-- /.box-header -->
              <div class="box-body">
                <style>
                  .layer {
                ...
                <div class="layer">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      $result = mysqli_query($connect, "SELECT *FROM reports042020 WHERE `region`='$region' AND `adress`='$adress' ORDER BY data ");
                      ...
                      while ($data1 = mysqli_fetch_array($result)) { ?>
                        ...
                        <tr>
                          ...
                          <td><!--
                            <form action="upd04.php" method="post">
                          ...
                          <td><strong><?= number_format($data1['dohod'] - $data1['stabrashod'] - $data1['tekrashod'], 0, '.', ' '); ?></strong></td>
                    ...
                    <tfoot>
                      <tr>
                        ...
                        $result2 = mysqli_query($connect, " SELECT id, region, SUM(dl), SUM(dm), SUM(dop), SUM(dohod),SUM(stabrashod),SUM(tekrashod),SUM(allclients),SUM(newclients),SUM(vzs),SUM(vozvrat),SUM(nakladnoy),COUNT(adress),SUM(chv)
                                        from reports042020 WHERE region = '$region'  AND adress ='$adress' ");
                        ...
                        <th><?= number_format($data2['SUM(dohod)'] - $data2['SUM(stabrashod)'] - $data2['SUM(tekrashod)'], 0, '.', ' '); ?></th>
                        ...
                        <th>
                          ...
                          $result3 = mysqli_query($connect, " SELECT * FROM reports042020 WHERE reg_date=(SELECT MAX(reg_date) FROM reports042020 WHERE region = '$region'  AND adress ='$adress') ");
        ...
        var areaChartData = {
          labels:
            ...
            [
              ...
              $result3 = mysqli_query($connect, "SELECT *FROM reports042020 WHERE `region`='$region' AND `adress`='$adress' ORDER BY data ");
          ...
          datasets: [
...

            {
              ...
              data: [
                ...
                $result3 = mysqli_query($connect, "SELECT *FROM reports042020 WHERE `region`='$region' AND `adress`='$adress' ");
