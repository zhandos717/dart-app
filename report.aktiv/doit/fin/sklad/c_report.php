...
<? //проверка существовании сессии
    ...
    $result12 = mysqli_query($connect,"SELECT adress, MIN(summstart), SUM(finhelp),SUM(comis),SUM(proc),SUM(vydacha),SUM(vozvrat),SUM(summsale),SUM(withdrawal),SUM(salesincome),SUM(summstart),SUM(endsumm) FROM repotscom WHERE region = '$region' AND datereport BETWEEN '$data1' AND '$data2'  GROUP BY adress ");
          ...
          <div class="col-md-12">
             <div class="box box-primary">
               <div class="box-header with-border">
                 ...
                 <div class="box-body">
                   <form action="a_report.php?id=3&region=<?=$region;?>" method="POST">
                  ...
                  <table id="example" class="tableas table table-hover table-bordered text-center">
                    <thead>
                        <tr>
                          ...
                          <th colspan="2" class="success">Реализация</th>
                        ...
                        <tr>
                          ...
                          <tbody style="white-space:nowrap;">
                            ...
                            while ($data12 = mysqli_fetch_array($result12)) {
                              ...
                              $adress = $data12['adress'];

                              $result13 = mysqli_query($connect,"SELECT SUM(summstart) FROM repotscom WHERE adress ='$adress'  AND datereport = '$data1' ");
                              $data13 = mysqli_fetch_array($result13);

                              $result14 = mysqli_query($connect,"SELECT SUM(endsumm) FROM repotscom WHERE adress ='$adress' AND datereport = '$data2' ");
                          ...
                          $result12 = mysqli_query($connect,"SELECT adress, SUM(summstart), SUM(finhelp),SUM(comis),SUM(proc),SUM(vydacha),SUM(vozvrat),SUM(summsale),SUM(withdrawal),SUM(salesincome),SUM(summstart),SUM(endsumm) FROM repotscom WHERE adress ='$adress' AND datereport BETWEEN '$data1' AND '$data2'  ");
                          $data12 = mysqli_fetch_array($result12);

                          $result16 = mysqli_query($connect,"SELECT SUM(summstart) FROM repotscom WHERE adress ='$adress' AND  datereport ='$data1' ");
                          $data16 = mysqli_fetch_array($result16);

                          $result15 = mysqli_query($connect,"SELECT adress, SUM(summstart), SUM(finhelp),SUM(comis),SUM(proc),SUM(vydacha),SUM(vozvrat),SUM(summsale),SUM(withdrawal),SUM(salesincome),SUM(summstart),SUM(endsumm) FROM repotscom WHERE adress ='$adress' AND  datereport ='$data2' ");
