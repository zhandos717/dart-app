                 ...
                 <div class="box-body">
                   <div class="table-responsive">
                     <table id="example" class="table table-striped table-bordered">
                       ...
                       <tbody>
                         <? $tables= R::findAll('callreports','datereport > ?',['2020-11-30']  );
                       ...
                       <tfoot>
                         <?
                          ...
                          FROM callreports WHERE datereport > '2020-11-30'")->fetch(PDO::FETCH_ASSOC);
                          ?>
                         <tr class="danger">
                           <th>Итого</th>
                           <?$i =1; while($i<=8):?>
                     ...
                     <table id="example" class="table table-striped table-bordered">
                       ...
                       <tbody>
                         <?
                          ...
                          FROM callreports WHERE datereport > '2020-11-30'  GROUP BY datereport")->fetchAll(PDO::FETCH_BOTH);
                          ?>
                         <? foreach ($result as $n): 
