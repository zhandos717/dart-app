...
include("../../bd.php");
if($_SESSION['logged_user']->status != 9)header('Location: index.php');
                  ...
                  <?
                   ...
                   foreach ($result as $data1){
                    ...
                    $res = R::getRow("SELECT * FROM reports WHERE adress = '$adress' ORDER BY reg_date DESC LIMIT 1");
                      ...
                      $datar = R::getCell("SELECT SUM(summarf) FROM rashodfillial WHERE  adress = '$adress' AND datarashoda BETWEEN '$data_begin' AND '$data_end' ");

             

                    $pr = $data1['SUM(dohod)'] - $datar;
