...
?>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Отчет ломбарда за Октябрь 2020, по региону - <b><?= $region; ?></b>
                      ...
                      ?>
                        ...
                        <tr>
                          <td>
                            ...
                            <form action="viewfilial.php" method="post">
                              <input type="text" name="region" value="<?= $region; ?>" hidden="" />
                              <input type="text" name="adress" value="<?= $data1['adress']; ?>" hidden="" />
                              <input type="submit" class="btn btn-block" name="gogo" value="<?= $data1['adress']; ?>" />
                            </form>
                          ...
                          <?
                          $result3 = mysqli_query($connect, " SELECT * FROM reports WHERE segdata=(SELECT MAX(segdata) FROM reports WHERE region = '$region' AND adress = '$filial' ) ");
