          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Переслать сообщение</h3>
                </div><!-- /.box-header -->
                ...
                <div class="box-body">
                  <div class="form-group">
                    <select name="komu" class="form-control select2" style="width: 100%;" required="required">
                      <option>Выберите контакт кому нужно написать</option>
                      <?
                      $resultu = mysqli_query($connect, "SELECT id,login,fio,doljnost,region,adress FROM diruser WHERE  login = 'superadmin'
                         ");
                  ...
                  <div class="form-group">
                    <input class="form-control" name="tema" placeholder="Subject:" value="Re <?=$datar['tema'];?>">
                  </div>
