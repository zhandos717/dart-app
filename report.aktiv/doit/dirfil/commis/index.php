      ...
      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-header">
            <a href="commis/report_print.php" target="_blank" title="Распечатать" class="btn btn-success"><i class="fa fa-print"></i></a>
            <a href="commis/print_report.php" target="_blank" title="Выгрузка в эксель" class="btn btn-danger"><i class="fa fa-file-excel-o"></i></a>
