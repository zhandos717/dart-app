<aside class="main-sidebar">
  <section class="sidebar">
    <ul class="sidebar-menu">
      <li><a href="/doit/adm/"><i class="fa fa-line-chart"></i> ГЛАВНАЯ</a></li>
          ...
          <li class="treeview <?= $active_report; ?>">
            <a href="#"><i class="fa fa-file-excel-o"></i> Отчет Ломбардов
              ...
              <ul class="treeview-menu">
                ...
                <!-- <li><a href="allfilesreports2021/december.php"><i class="fa fa-calendar-plus-o"></i>Декбарь</a></li>
                ...
                <li><a href="allfilesreports2022/january.php"><i class="fa fa-calendar-plus-o"></i>Январь 2022</a></li>
                <!-- <li><a href="january.php"><i class="fa fa-calendar-plus-o"></i>Январь</a></li> -->
                <li class="treeview <?= $active_call; ?>">
                  <a href="#">
                    <i class="fa fa-laptop"></i> <span>Отчеты за 2021 год</span> <i class="fa fa-angle-left pull-right"> </i>
                  </a>
                  <ul class="treeview-menu">
                    <li><a href="allfilesreports2021/december.php"><i class="fa fa-calendar-plus-o"></i>Декбарь</a></li>
                    <li><a href="allfilesreports2021/november.php"><i class="fa fa-calendar-plus-o"></i>Ноябрь</a></li>
      ...
      <li class="treeview <?= $active_mag; ?>">
        ...
        <ul class="treeview-menu">
          <li><a href="get_sales.php"><i class="fa fa-gg"></i>Фильтр отчетов</a></li>
          <li><a href="not_sold.php"><i class="fa fa-gg"></i>Не проторгованные товары</a></li>
          <li><a href="search.php"><i class="fa fa-gg"></i>Поиск товара</a></li>
          <li><a href="recurring_items.php"><i class="fa fa-gg"></i>Повторяющиеся товары</a></li>
          <li><a href="total_shop.php?start=2022-02-01&end=2022-02-31"><i class="fa fa-calendar"></i>Февраль</a></li>
          <li><a href="total_shop.php?start=2022-01-01&end=2022-01-31"><i class="fa fa-calendar"></i>Январь</a></li>
          <li class="treeview">
      ...
      <li class="<?= $active_lombard; ?> treeview">
        <a href="index.php">
          <i class="fa fa-cube"></i> <span>
            Расходы ломбардов </span>

          <i class="fa fa-angle-left pull-right"> </i>
        </a>
        <ul class="treeview-menu">
          <li>
            <a href="filtrRashod.php">
              <i class="fa fa-gg"></i>
              Фильтрация/поиск
            </a>
          </li>
          <li>
            <a href="rashody.php?month=2">
              <i class="fa fa-cube"></i>
              Февраль 2022
            </a>
          </li>
          <li>
            <a href="rashody.php?month=1">
              <i class="fa fa-cube"></i>
              Январь 2022
            </a>
          </li>
          <li>
            <a href="allfilesrashody2022/rashody122021.php">
              <i class="fa fa-cube"></i>
              Декабрь 2021
            </a>
          </li>
      ...
      <li class="<?= $active_lombard; ?> treeview">
        ...
        <ul class="treeview-menu">
          <li>
            <a href="filtrRashod_obs.php">
              <i class="fa fa-gg"></i>
              Фильтрация/поиск
            </a>
          </li>
          <li>
            <a href="rashody_obs.php?month=2">
              <i class="fa fa-cube"></i>
              Февраль 2022
            </a>
          </li>
          <!-- <li>
            <a href="rashody_obs.php?month=1">
              <i class="fa fa-cube"></i>
              Январь 2022
            </a>
          </li> -->
      ...
      <li class="treeview">
        <a href="grback.php">
          ...
          <span>График работы БЭКофиса</span>
        </a>
      </li>
      <li class="treeview">
        <a href="viewraport.php">
          <i class="fa fa-windows"></i>
          <span> РАПОРТ </span>
        </a>
      </li>
      <li class="treeview">
        <a href="testtabel.php">
