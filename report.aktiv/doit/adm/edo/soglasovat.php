          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div class="box box-primary">
                ...
                <form action="soglasovattobuh.php" method="post" enctype="multipart/form-data">
                ...
                <div class="box-body">
                  <div class="form-group">
                    <select name="komu" class="form-control select2" style="width: 100%;" required="required">
                      ...
                      <?
                      $resultu = mysqli_query($connect, "SELECT id,login,fio,doljnost,region,adress FROM diruser WHERE login = 'buh-2@astana.kz'   ");
                  ...
                  <div class="form-group">
                    <input class="form-control" name="tema" placeholder="Subject:" value="Re <?=$datar['tema'];?> СОГЛАСОВАНИЕ от Генерального директора">
                  </div>

                  <div class="form-group">
                    <textarea id="compose-textarea" name="text_sms" class="form-control" style="height: 300px">
                      <b>СОГЛАСОВАНИЕ от Генерального директора</b><br><br><br>
                      <i>здесь текст, комментарий, указание<i/>
                ...
                <div class="box-footer">
                  <div class="pull-right">
                    ...
                    <button type="submit" name="gopismo" class="btn btn-primary"><i class="fa fa-envelope-o"></i> Отправить СОГЛАСОВАНИЕ</button>
                  </div>
