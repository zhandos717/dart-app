...
if ($status == 3) :
    ...
    $logingendir = $_SESSION['logged_user']->login; //для определения ГД
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <?
                    $kto3 = $_SESSION['logged_user']->login;
                    if($kto3=='superadmin'){
                    ?>
               ...
               <div class="box-footer">
                 <div class="pull-right">
                   ...
                   <table>
                     <tr>
                      <?
                        if($logingendir=='superadmin'){
                      ?>
                       <td>
                         <form class="" action="otkaz.php" method="post">
                             ...
                             <button name="answerto" value="true" class="btn btn-danger"><i class="fa fa-share"></i> ОТКАЗАТЬ</button>
                           </form>
                       </td>
                       <td>&nbsp;</td>
                       <td><form class="" action="soglasovat.php" method="post">
                         <input type="text" hidden="hidden" name="id" value="<?=$id;?>">
                         <input type="text" hidden="hidden" name="fioOtkovo" value="<?=$fioOtkovo;?>">
                         <button name="resend" value="true" class="btn btn-success"><i class="fa fa-reply"></i> СОГЛАСОВАТЬ</button>
                             </form>
                       </td>
                       <td>&nbsp;</td>
                       <?}
