          ...
          <div class="row">
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="active"><a href="otkazannyie.php"><i class="fa fa-envelope-o"></i> Отказанные СЗ</a></li>
                    <?}?>
                  </ul>
                </div><!-- /.box-body -->
              </div><!-- /. box -->
            ...
            <div class="col-md-9">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Отказанные служебки</h3>
                ...
                <div class="box-body no-padding">
                  ...
                  <div class="table-responsive mailbox-messages">
                    <table class="table table-hover table-striped">
                      <tbody>
                        <?
                        $result2 = mysqli_query($connect, "SELECT * FROM sluzhebki WHERE otkovo = '$otkovo' AND statusz=0 ORDER BY id DESC ");
                        ...
                        <tr>
                          ...
                          <td class="mailbox-subject"><b>
                            <form class="" action="readMailOtkazan.php" method="post">
