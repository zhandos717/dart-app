      ...
      <div class="row">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                ?>
                  ...
                  <li class="active"><a href="soglasovannyyie.php"><i class="fa fa-envelope-o"></i> Согласованные СЗ</a></li>
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Согласованные служебки</h3>
            ...
            <div class="box-body no-padding">
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  <tbody>
                    <?
                    $result2 = mysqli_query($connect, "SELECT * FROM sluzhebki WHERE otkovo = '$otkovo' AND statusz=2 ORDER BY id DESC ");
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="mailbox-subject"><b>
                            <a title='Открыть' style="color: black;" href="readMailoplacheno.php?id=<?= $data2['id']; ?>">
                              <?= $data2['tema']; ?>
                            </a>
