<aside class="main-sidebar">
  <section class="sidebar">
    <ul class="sidebar-menu">
          ...
          <li class="treeview <?= $active_report; ?>">
            <a href="#"><i class="fa fa-file-excel-o"></i> Отчет Ломбардов
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="https://report.aktiv-market.kz/doit/adm/allfilesreports2021/november.php"><i class="fa fa-calendar-plus-o"></i>Ноябрь
                  </a></li>
      ...
      <li class="treeview">
        <a href="/doit/adm/rashody.php">
          <i class="fa fa-file"></i> <span> Расходы <label class="badge">тест</label> </span>
        </a>
      </li>
