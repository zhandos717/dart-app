...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Расходы ОБС за <?=$namemonth;?> 2022 год
      </h1>
    </section>
    <!-- Main content -->
        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="country">
              <form action="rashody/rashodpokz_obs.php" method="post">
            ...
            <div class="tab-pane" id="regions">
              <form action="rashody/rashodpogoroduobs.php" method="post">
                <div class="form-group">
                  <input class="form-control" type="date" name="datarashoda" required="required">
                </div>
                <div class="form-group">
            ...
            <div class="tab-pane" id="branches">
              <form action="rashody/rashodpofillobs.php" method="post">
                <div class="form-group">
                  <input class="form-control" type="date" name="datarashoda" required="required">
                </div>
                <div class="form-group">
        ...
        <div class="box box-info">
          ...
          <form class="form-horizontal">
            ...
            <div class="box-footer">
              ...
              <a href="filtrRashod_obs.php" class="btn btn-info pull-right">Фильтр по расходам</a>
              <a href="fordelRashod_obs.php?month=<?=$month;?>" class="btn btn-danger">Для удаление</a>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="datatable-tabletools" class="table table-bordered table-striped">
                ...
                <tbody>
                  <? $result = mysqli_query($connect, "SELECT region, comments, datarashoda, SUM(summarf)  AS summarf FROM rashodfillialobs WHERE datarashoda BETWEEN '$data_begin' AND '$data_end'  GROUP BY comments ");
                  while ($data = mysqli_fetch_array($result)) { ?>
                    <tr>
                      <td><?= $data['region']; ?></td>
                      <!-- <td><?= $data['adress']; ?></td> -->
