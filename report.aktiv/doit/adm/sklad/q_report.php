                  ...
                  <table id="example" class="tableas table table-hover table-bordered text-center">
                    <thead>
                        ...
                        <tr>
                          ...
                          $result12 = mysqli_query($connect,"SELECT adress, SUM(summstart), SUM(finhelp),SUM(comis),SUM(proc),SUM(vydacha),SUM(vozvrat),SUM(summsale),SUM(withdrawal),SUM(salesincome),SUM(summstart),SUM(endsumm) FROM repotscom WHERE  region = '$region' AND datereport BETWEEN '$data1' AND '$data2'  ");
                          ...
                          $result15 = mysqli_query($connect,"SELECT adress, SUM(summstart), SUM(finhelp),SUM(comis),SUM(proc),SUM(vydacha),SUM(vozvrat),SUM(summsale),SUM(withdrawal),SUM(salesincome),SUM(summstart),SUM(endsumm) FROM repotscom WHERE region = '$region' AND datereport ='$data2' ");
