              ...
              <div class="">
                <table id="datatable-tabletools" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    $result = R::findAll('reports012022', 'region = ? AND adress = ? ORDER BY data', [$region, $adress]);
                    ...
                    foreach ($result as $data1) {
                      ...
                      $datar = R::getRow("SELECT SUM(summarf) FROM rashodfillial WHERE adress = '$adress' AND datarashoda = '$datarashoda'");

                      $pribl = $data1['dohod'] - $datar['SUM(summarf)'];
                      // $pribl = $data1['dohod'] - $data1['stabrashod'] - $data1['tekrashod'];

                      $resultc = mysqli_query($connect, "SELECT comments FROM `rashodfillial` WHERE region = '$region' AND adress = '$adress' AND datarashoda = '$datarashoda'");

                      $datac = mysqli_fetch_array($resultc);

                      $chistpribl = percent($pribl,20);
                    ...
                    ?>
                      ...
                      <tr style="white-space:nowrap;">
                        <td><a href="look01.php?id=<?= $data1['id']; ?>" class="btn btn-warning"><i class="fa fa-pencil"></i></a></td>
