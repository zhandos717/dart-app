                ...
                <table class="table table-bordered table-hover" style="white-space:nowrap;" id="datatable-tabletools">
                  ...
                  <tbody>
                    ...
                    while ($data1 = mysqli_fetch_array($result)) {
                      ...
                      <tr>
                        <td><a href="viewreportregion04.php?region=<?= $region  ?>"> <?= $region  ?></a></td>
                        <td>
              ...
              <div class="table-responsive">
                <table class="table table-bordered table-hover" style="white-space:nowrap;">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <td><a class="btn btn-block bg-olive" href="viewreportregion04.php?region=<?= $data1['region']; ?>"><?= $data1['region']; ?></a></td>
                        <td>
                        ...
                        <td> <? echo number_format($ras_obs, 0, '.', ' ');
                              $ras_total_obs += $ras_obs; ?></td>
                        <!-- <td>0</td> -->
                        <? $chistaya = $data1['SUM(p1)'] + $data19['SUM(proc)'] + ($data8['SUM(cena_pr)'] - $data8['SUM(summa_vydachy)']) + $data8['SUM(profit)'] - $data451['SUM(summa)'] + ($acc['SUM(price)'] - $acc['SUM(purchaseamount)'])- $ras_obs;
                  ...
                  <tfoot>
                    <tr class="bg-gray">
                      ...
                      <!-- <th></th> -->
                      <th><?= number_format($ras_total_obs, 0, '.', ' '); ?></th>
                      ...
                      <th>
                        <? echo number_format($summa_vydachy3, 0, '.', ' ');
                        unset($dohod, $dohodm, $count, $newclients, $summa_vydachy, $summa_vydachy2, $summa_vydachy3); ?>
                      </th>
                    </tr>
                  </tfoot>
                </table>
                ...
                <table class="table table-bordered table-hover" style="white-space:nowrap;">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <!-- Аксесуары -->
                        <? $chistaya1 = $data2['comis'] + $data2['proc'] + ($data2['cena_pr'] - $data2['sale']) + $data2['profit'] + ($data2['price'] - $data2['purchaseamount'])- $ras_tbs;
                        $tbs_chistaya = percent_comiss($chistaya1);
                        ?>
                        <td><?= number_format($ras_tbs, 0, '.', ' ');
                            $ras_total_tbs += $ras_tbs; ?></td>
                        <th>
                  ...
                  <tfoot>
                    <tr class="bg-gray">
                      ...
                      <td><?= number_format($ras_total_tbs, 0, '.', ' '); ?></td>
