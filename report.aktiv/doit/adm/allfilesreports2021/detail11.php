            ...
            <div class="table-responsive">
              <table class="table table-bordered table-hover">
                ...
                <tbody>
                  <?
                      $i = 1;
                      $result = mysqli_query($connect, "SELECT *FROM sales11 WHERE data = '$data_z'  AND region = '$region' AND adress = '$shop' AND fromtovar = '$fromtovar' AND statustovar IS NULL ");
                  ...
                  <tr>
                    ...
                    <td style="white-space: nowrap;">
                      ...
                      <form action="upd_sales11.php" method="post" style="display: inline;">
                  ...
                  <tr style="background: #d3d7df; color: black;">
                    <?
                        $result2 = mysqli_query($connect, " SELECT id, region, SUM(summaprihod),SUM(predoplata),SUM(summareal),SUM(pribl)
                                        from sales11 WHERE data = '$data_z' AND region = '$region' AND adress = '$shop' AND fromtovar = '$fromtovar' AND statustovar IS NULL ");
