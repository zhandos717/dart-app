...
if ($_SESSION['logged_user']->status == 3) :
  ...
  $report = R::load('reports082021',  $_POST['id']);
...
header('Location: https://report.aktiv-market.kz/doit/adm/allfilesreports2021/viewfilial08.php?region='.$report->region.'&adress='.$report->adress)
