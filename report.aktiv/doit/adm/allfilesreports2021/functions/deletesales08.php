...
?>
    ...
    $result = mysqli_query($connect, "DELETE FROM sales08 WHERE id = $id ");


    echo "<meta http-equiv='Refresh' content='0; URL=../detail08.php?region=$region&shop=$shop&data_z=$data_z'>";
    ?>
