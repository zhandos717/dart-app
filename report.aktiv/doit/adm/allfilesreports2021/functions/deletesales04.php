...
?>
    ...
    $result = mysqli_query($connect, "DELETE FROM sales04 WHERE id = $id ");


    echo "<meta http-equiv='Refresh' content='0; URL=../viewshop04.php?region=$region&shop=$shop&data_z=$data_z'>";
    ?>
