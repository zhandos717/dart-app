...
?>
    ...
    $result = mysqli_query($connect, "DELETE FROM sales10 WHERE id = $id ");


    echo "<meta http-equiv='Refresh' content='0; URL=../detail10.php?region=$region&shop=$shop&data_z=$data_z'>";
    ?>
