      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Отчет за Апрель 2021</h3>
          </div><!-- /.box-header -->
          <div class="box-body">
            <div class="">
              <table id="datatable-tabletools" class="table table-bordered table-hover">
                ...
                <tbody>
                  <?
                      ...
                      $result = R::findAll('reports042021','region = ? AND adress = ? ORDER BY data',[$region,$adress ]);

                      $datapl =R::findOne('planlombard','region = ? AND adress=?',[$region,$adress]);
                      $planden = $datapl['plan']/31;    //еждневный план = Ежемесячный план деленная на 30 дней
                  ...
                  <tr style="white-space:nowrap;">
                    <td>
                      <!-- <a href="look.php?id=<?= $data1['id']; ?>" class="btn btn-warning"><i class="fa fa-pencil"></i></a> -->
                      ****
                    </td>
