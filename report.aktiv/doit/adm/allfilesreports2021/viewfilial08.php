              ...
              <div class="">
                <table id="datatable-tabletools" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    $result = R::findAll('reports082021', 'region = ? AND adress = ? ORDER BY data', [$region, $adress]);
                    ...
                    ?>
                      ...
                      <tr style="white-space:nowrap;">
                        <td><a href="look08.php?id=<?= $data1['id']; ?>" class="btn btn-warning"><i class="fa fa-pencil"></i></a></td>
