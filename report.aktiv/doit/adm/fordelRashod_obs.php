                    ...
                    <div class="box-body">
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                          ...
                          $resultq1 = mysqli_query($connect, "SELECT * FROM rashodfillialobs WHERE datarashoda BETWEEN '$data_begin' AND '$data_end' ");
                          ...
                          <tr>
                            ...
                            <td>
                              <form class="" action="reRashod_obs.php" method="post">
                            ...
                            <td>
                              <form class="" action="rashody/deleteRashod_obs.php" method="post">
                                <input type="text" hidden="hidden" name="id" value="<?=$dataq1['id'];?>">
