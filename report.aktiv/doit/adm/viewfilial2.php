                ...
                <table id="datatable-tabletools" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    foreach ($result as $data1) {
                      ...
                      $resultr = mysqli_query($connect, "SELECT SUM(summarf) FROM `rashodfillial` WHERE region = '$region' AND adress = '$adress'
                                                       AND datarashoda = '$datarashoda'");
                      $datar = mysqli_fetch_array($resultr);

                      $resultsr = mysqli_query($connect, "SELECT SUM(summarf) FROM `rashodfillial` WHERE region = '$region' AND adress = '$adress'
                                                       ");
                    ...
                    ?>
                      ...
                      <tr style="white-space:nowrap;">
                        <td><a href="look.php?id=<?= $data1['id']; ?>" class="btn btn-warning"><i class="fa fa-pencil"></i></a></td>
                        ...
                        <td><?= number_format($datar['SUM(summarf)'], 2, '.', ' '); ?></td>
                  ...
                  <tfoot>
                    <tr class="bg-olive">
                      ...
                      <td><?= number_format($summarashodov, 2, '.', ' '); ?></td>
