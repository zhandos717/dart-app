...
if (isset($_SESSION['logged_user'])) :   //если сущесттвует пользователь
  ...
  if ($_SESSION['logged_user']->status == 3) :
    $active_mag = 'active';
    $result22 = mysqli_query($connect, " SELECT SUM(summareal), SUM(summaprihod), SUM(pribl), SUM(summazaden) from sales07  ");
...
// COUNT(*), id,  data, summazaden, SUM(summazaden), SUM(),,,
                      ...
                      ?>
                        ...
                        <tr>
                          ...
                          <td><a href="viewshop07.php?region=<?= $data1['region']; ?>&shop=<?= $data1['adress']; ?>"><?= $data1['region']; ?>-<?= $data1['adress']; ?></a></td>
                    ...
                    <tfoot>
                      <?
                      $result2 = mysqli_query($connect, " SELECT SUM(summareal), SUM(summaprihod), SUM(pribl), SUM(summazaden) from sales07  ");
