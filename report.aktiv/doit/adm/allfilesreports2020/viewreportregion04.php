...
?>
    ...
    $result2 = mysqli_query($connect, " SELECT id, region, SUM(dl),SUM(dm),SUM(dop), SUM(dohod),SUM(stabrashod),SUM(tekrashod),SUM(allclients),
                                        SUM(newclients),SUM(vzs),SUM(vozvrat),SUM(nakladnoy),COUNT(adress),SUM(chv) from reports042020 WHERE `region`='$region'  ");
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Отчет за АПРЕЛЬ 2020, за весь регион - <b><?= $region; ?></b>
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      ?>
                        ...
                        <tr>
                          <td><a href="viewfilial04.php?region=<?= $region; ?>&adress=<?= $data1['adress']; ?>"><?= $filial; ?></a></td>
                          ...
                          <?
                          $result3 = mysqli_query($connect, " SELECT * FROM reports042020 WHERE segdata=(SELECT MAX(segdata) FROM reports042020 WHERE region = '$region' AND adress = '$filial' ) ");
