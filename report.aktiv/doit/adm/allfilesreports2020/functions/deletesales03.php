...
?>
    ...
    $result = mysqli_query($connect, "DELETE FROM sales03 WHERE id = $id ");


    echo "<meta http-equiv='Refresh' content='0; URL=../detail03.php?region=$region&shop=$shop&data_z=$data_z'>";
    ?>
