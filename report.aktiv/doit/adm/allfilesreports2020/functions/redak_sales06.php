...
?>
    ...
    $result = mysqli_query($connect, "UPDATE sales06 SET

data = '$data', codetovar = '$codetovar', tovarname = '$tovarname', summaprihod ='$summaprihod', predoplata = '$predoplata', summareal = '$summareal', pribl = '$pribl',

vid = '$vid', saler = '$saler', pokupatel = '$pokupatel', summazaden = '$summazaden'

WHERE id = $id ");
    echo "<meta http-equiv='Refresh' content='0; URL=../detail06.php?region=$region&shop=$shop&data_z=$data_z'>";
    ?>
