...
?>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Магазин <?= $region; ?>-<?= $shop; ?>, ОТЧЕТ за МАЙ 2020
        </h1>
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    <thead>
                      <tr style="background: #398ebd; color: white;">
                        ...
                        <th>СУММА КРЕДИТА</th>
                        <th>ПРЕДОПЛАТА</th>
                        <th>Сумма реализации (с вычетом %)</th>
                        <th>ПРИБЫЛЬ</th>
                        <th>ВИД</th>
                        <th>ПРОДАВЕЦ</th>
                        <th>ПОКУПАТЕЛЬ</th>
                    ...
                    <tbody>
                      ...
                      $result = mysqli_query($connect, "SELECT *FROM sales05 WHERE data = '$data_z'  AND region = '$region' AND adress = '$shop' ");
                      ...
                      while ($data1 = mysqli_fetch_array($result)) { ?>
                        ...
                        <tr>
                          <td>
                            <form action="upd_sales05.php" method="post">
                          ...
                          <td><?= number_format($data1['summakredit'], 0, '.', ' '); ?></td>
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <?
                        $result2 = mysqli_query($connect, " SELECT id, region, SUM(summaprihod),SUM(summakredit),SUM(summareal),SUM(pribl)
                                        from sales05 WHERE data = '$data_z' AND region = '$region' AND adress = '$shop' ");
                        ...
                        <th style="background: #398ebd; color: white;"><?= number_format($data2['SUM(summakredit)'], 0, '.', ' '); ?></th>
                        <th style="background: #398ebd; color: white;"><?= number_format($data2['SUM(tekrashod)'], 0, '.', ' '); ?></th>
