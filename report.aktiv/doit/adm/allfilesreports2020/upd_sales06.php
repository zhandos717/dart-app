...
$result = mysqli_query($connect, " SELECT *from sales06 WHERE id = '$id'");
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="box box-info">
              ...
              <!-- form start -->
              <form class="form-horizontal" action="functions/redak_sales06.php" method="post">
                <div class="box-body">
              ...
              <a href="functions/deletesales06.php?id=<?= $id; ?>&region=<?= $data['region']; ?>&adress=<?= $data['adress']; ?>&data=<?= $data['data']; ?>"><button class="btn btn-danger">УДАЛИТЬ</button></a>
            </div><!-- /.box -->
