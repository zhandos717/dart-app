...
$result = mysqli_query($connect, " SELECT *from reports022020 WHERE id = '$id'");
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="box box-info">
              ...
              <!-- form start -->
              <form class="form-horizontal" action="functions/redak02.php" method="post">
                <div class="box-body">
              ...
              <a href="functions/deleted02.php?id=<?= $id; ?>"><button class="btn btn-default">УДАЛИТЬ</button></a>
            </div><!-- /.box -->
