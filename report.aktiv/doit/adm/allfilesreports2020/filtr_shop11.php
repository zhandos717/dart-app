...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <a href="viewshop11.php?region=<?=$regionshop;?>&shop=<?=$shopadres;?>&from=<?=$fromtovar?>">Идем назад</a>
        </h1>
        <ol class="breadcrumb">
                    ...
                    <div class="box-body">
                        ...
                        <div class="layer">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                  <?
                      $result = mysqli_query($connect, "SELECT *FROM sales11 WHERE saler ='$saler'  AND fromtovar = '$fromtovar' AND `data` BETWEEN '$date1' AND '$date2' AND  statustovar IS NULL ");
                      while ($data1 = mysqli_fetch_array($result)) { ?>
                                ...
                                <tfoot>
                                    <tr>
                    <?
                        $result2 = mysqli_query($connect, " SELECT SUM(summaprihod), SUM(predoplata), SUM(summareal), SUM(pribl) from sales11 WHERE  saler ='$saler' AND fromtovar = '$fromtovar' AND `data` BETWEEN '$date1' AND '$date2' AND  statustovar IS NULL  ");
