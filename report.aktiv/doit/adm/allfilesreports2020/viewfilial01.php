...
?>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          <?= $region; ?>/<?= $adress; ?>
          <small><a href="january.php">назад к списку</a></small>
        </h1>
        <ol class="breadcrumb">
          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                <h3 class="box-title">Отчет за январь 2020</h3>
              </div><!-- /.box-header -->
              <div class="box-body">
                <style>
                  .layer {
                ...
                <div class="layer">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      $result = mysqli_query($connect, "SELECT *FROM reports012020 WHERE `region`='$region' AND `adress`='$adress' ORDER BY data ");
                      ...
                      while ($data1 = mysqli_fetch_array($result)) { ?>
                        ...
                        <tr>
                          ...
                          <td><?= number_format($data1['tekrashod'], 0, '.', ' '); ?></td>
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <?
                        $result2 = mysqli_query($connect, " SELECT id, region, auktech, SUM(dohod),SUM(stabrashod),SUM(tekrashod),SUM(allclients),SUM(newclients),SUM(vzs),SUM(vozvrat),SUM(nakladnoy),COUNT(adress),SUM(chv)
                                        from reports012020 WHERE region = '$region'  AND adress ='$adress' ");
                        ...
                        <th>
                          ...
                          $result3 = mysqli_query($connect, " SELECT * FROM reports012020 WHERE reg_date=(SELECT MAX(reg_date) FROM reports012020 WHERE region = '$region'  AND adress ='$adress') ");
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">Нал в залоге(серая полоса) и Аукционист техника(синяя полоса)A</h3>
          ...
          <div class="col-md-6">
            ...
            <div class="box box-info">
              <div class="box-header with-border">
                <h3 class="box-title">Нал в залоге(серая линия) и Аукционист техника(синяя линия) B</h3>
                <div class="box-tools pull-right">
                  <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                  <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                </div>
        ...
        var areaChartData = {
          labels:
            ...
            [
              ...
              $result3 = mysqli_query($connect, "SELECT *FROM reports012020 WHERE `region`='$region' AND `adress`='$adress' ORDER BY data ");
          ...
          datasets: [
...

            {
              ...
              data: [
                ...
                $result3 = mysqli_query($connect, "SELECT *FROM reports012020 WHERE `region`='$region' AND `adress`='$adress' ");
