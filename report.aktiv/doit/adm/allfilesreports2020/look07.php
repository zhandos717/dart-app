...
$result = mysqli_query($connect, " SELECT *from reports072020 WHERE id = '$id'");
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="box box-info">
              ...
              <!-- form start -->
              <form class="form-horizontal" action="functions/redak07.php" method="post">
                <div class="box-body">
              ...
              <a href="functions/deleted07.php?id=<?= $id; ?>&region=<?= $data['region']; ?>&adress=<?= $data['adress']; ?>"><button class="btn btn-default">УДАЛИТЬ</button></a>
            </div><!-- /.box -->
