...
?>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Магазин <?= $region; ?>-<?= $shop; ?>, ОТЧЕТ за АВГУСТ 2020
        </h1>
        <ol class="breadcrumb">
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      $result = mysqli_query($connect, "SELECT data, SUM(summareal), SUM(summazaden), SUM(pribl), COUNT(*)
                                        from sales08  WHERE region = '$region' AND adress = '$shop' AND from_tovar = '$fromtovar' GROUP BY data ");
                      ...
                      ?>
                        <tr>
                          ...
                          <td><a href="detail08.php?region=<?= $region; ?>&shop=<?= $shop; ?>&data_z=<?= $data1['data']; ?>&from=<?=$fromtovar;?>"><?= date("d.m.Y", strtotime($data1['data'])); ?></a></td>
                    ...
                    <tfoot>
                      <tr style="background: #398ebd; color: white;">
                        ...
                        $result2 = mysqli_query($connect, " SELECT SUM(summareal), SUM(summazaden), SUM(pribl)
                                        from sales08  WHERE region = '$region' AND adress = '$shop' AND from_tovar = '$fromtovar'");
