          ...
          <div class="col-md-12">
            <div class="box">
              <div class="box-header">
                <h3 class="box-title">Отчет за Октябрь 2020</h3>
              </div><!-- /.box-header -->
              <div class="box-body">
                <style>
                  .layer {
                ...
                <div class="layer">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <?
                      $result = mysqli_query($connect, "SELECT *FROM reports102020 WHERE `region`='$region' AND `adress`='$adress' ORDER BY data ");
                      while ($data1 = mysqli_fetch_array($result)) { ?>
                        <tr>
                          <td><a href="look10.php?id=<?= $data1['id']; ?>"><i class="fa fa-pencil"></i></a></td>
                    ...
                    <tfoot>
                      <tr style="background: #398ebd; color: white;">
                        ...
                        $result2 = mysqli_query($connect, " SELECT id, region, auktech, SUM(dl),SUM(dm),SUM(dop), SUM(dohod),SUM(stabrashod),SUM(tekrashod),SUM(allclients),SUM(newclients),SUM(vzs),SUM(vozvrat),SUM(nakladnoy),COUNT(adress),SUM(chv)
                                        from reports102020 WHERE region = '$region'  AND adress ='$adress' ");
                        ...
                        <th>
                          ...
                          $result3 = mysqli_query($connect, " SELECT * FROM reports102020 WHERE segdata=(SELECT MAX(segdata) FROM reports102020 WHERE region = '$region'  AND adress ='$adress') ");
        ...
        var areaChartData = {
          labels:
            ...
            [
              ...
              $result3 = mysqli_query($connect, "SELECT *FROM reports102020 WHERE `region`='$region' AND `adress`='$adress' ORDER BY data ");
          ...
          datasets: [
...

            {
              ...
              data: [
                ...
                $result3 = mysqli_query($connect, "SELECT *FROM reports102020 WHERE `region`='$region' AND `adress`='$adress' ");
