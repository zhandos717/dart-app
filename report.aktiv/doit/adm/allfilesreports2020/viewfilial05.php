                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      while ($data1 = mysqli_fetch_array($result)) { ?>
                        ...
                        <tr>
                          <td><a href="look05.php?id=<?= $data1['id']; ?>"><i class="fa fa-pencil"></i></a></td>
                    ...
                    <tfoot>
                      <tr style="background: #398ebd; color: white;">
                        ...
                        <th>
                          ...
                          $result3 = mysqli_query($connect, " SELECT * FROM reports052020 WHERE segdata=(SELECT MAX(segdata) FROM reports052020 WHERE region = '$region'  AND adress ='$adress') ");
