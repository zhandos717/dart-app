...
$result = mysqli_query($connect, " SELECT *from sales10 WHERE id = '$id'");

$data = mysqli_fetch_array($result);
$fromtovar = $data['fromtovar'];
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="box box-info">
              ...
              <!-- form start -->
              <form class="form-horizontal" action="functions/redak_sales10.php" method="post">
                <div class="box-body">
                  <input name="id" value="<?= $id; ?>" hidden="" />
                  <input name="region" value="<?= $region; ?>" hidden="" />
                  <input name="adress" value="<?= $adress; ?>" hidden="" />
                  <input name="fromtovar" value="<?= $fromtovar; ?>" hidden="" />
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputEmail3" name="pribl" value="<?= $data['pribl']; ?>" readonly />
                    </div>
                  </div>
                  <div class="form-group">
              ...
              <a href="functions/deletesales10.php?id=<?= $id; ?>&region=<?= $data['region']; ?>&adress=<?= $data['adress']; ?>&data=<?= $data['data']; ?>"><button class="btn btn-danger">УДАЛИТЬ</button></a>
            </div><!-- /.box -->
