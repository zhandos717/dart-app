...
$result = mysqli_query($connect, " SELECT *from reports102020 WHERE id = '$id'");
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="box box-info">
              ...
              <!-- form start -->
              <form class="form-horizontal" action="functions/redak10.php" method="post">
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputEmail3" name="segdata" value="<?= $data['segdata']; ?>" />
                    </div>
                  </div>
                  <div class="form-group">
              ...
              <a href="functions/deleted10.php?id=<?= $id; ?>&region=<?= $data['region']; ?>&adress=<?= $data['adress']; ?>"><button class="btn btn-default">УДАЛИТЬ</button></a>
            </div><!-- /.box -->
