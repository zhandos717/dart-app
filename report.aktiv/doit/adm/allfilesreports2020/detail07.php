                ...
                <div class="layer">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      $result = mysqli_query($connect, "SELECT *FROM sales07 WHERE data = '$data_z'  AND region = '$region' AND adress = '$shop' ");
                      ...
                      while ($data1 = mysqli_fetch_array($result)) { ?>
                        ...
                        <tr>
                          <td>
                            <form action="upd_sales07.php" method="post">
                    ...
                    <tfoot>
                      <tr style="background: #d3d7df; color: black;">
                        ...
                        $result2 = mysqli_query($connect, " SELECT id, region, SUM(summaprihod),SUM(predoplata),SUM(summareal),SUM(pribl)
                                        from sales07 WHERE data = '$data_z' AND region = '$region' AND adress = '$shop' ");
