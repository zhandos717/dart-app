...
if ($status == 10) :
    ...
    $resulto = mysqli_query($connect, "SELECT COUNT(id) FROM sluzhebki WHERE komu = '$komu' AND statusz = '3'");
    $datao = mysqli_fetch_array($resulto);
    $countido = $datao['COUNT(id)'];
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li><a href="index.php"><i class="fa fa-inbox"></i> Согласованные <span class="label label-primary pull-right">Новые СЗ <?=$countid;?></span></a></li>
                    <li class="active"><a href="oplachennyie.php"><i class="fa fa-file-text-o"></i> Оплаченные <span class="label label-primary pull-right"><?=$countido;?></span></a></li>
                  ...
                  <div class="table-responsive mailbox-messages">
                    <table class="table table-hover table-striped">
                      <tbody>
                        <?
                        $komu = $_SESSION['logged_user']->login;
                        $result2 = mysqli_query($connect, "SELECT * FROM sluzhebki WHERE komu = '$komu' AND statusz = '3' ORDER BY id DESC");
