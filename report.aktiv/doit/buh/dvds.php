    ...
    <!-- <div class="content-wrapper"> -->
      ...
      <? //проверка существовании сессии
        ...
        if($_POST['date1'] AND $_POST['date2']){
          ...
          $result12 = mysqli_query($connect,"SELECT adress, MIN(summstart), SUM(finhelp),SUM(comis),SUM(proc),SUM(vydacha),SUM(vozvrat),SUM(summsale),SUM(withdrawal),SUM(salesincome),SUM(summstart),SUM(endsumm) FROM repotscom WHERE datereport BETWEEN '$data1' AND '$data2'  GROUP BY adress ");
                ...
                <div class="col-md-12">
                   <div class="box box-primary">
                     <div class="box-header with-border">
                       ...
                       <div class="box-body">
                         <form action="dvds.php" method="POST">
                        ...
                        <table id="example" class="tableas table table-hover table-bordered text-center">
                          <thead>
                              <tr>
                                ...
                                <th rowspan="2" class="success">Название филиала</th>
                              ...
                              <tr>
                                ...
                                <tbody style="white-space:nowrap;">
                                  ...
                                  while ($data12 = mysqli_fetch_array($result12)) {
                                    ...
                                    $result13 = mysqli_query($connect,"SELECT * FROM repotscom WHERE adress ='$adress'  AND datereport = '$data1' ");
                                  ...
                                  <td><?= number_format($data13['summstart'], 0, '.', ' '); ?></td>
