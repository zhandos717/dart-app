      ...
      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-header">
            <?if($_SESSION['logged_user']->region == 'Астана'):?>
            <form action="reportcom.php" method="POST">
              ...
              <div class="col-lg-3">
                <div class="input-group">
                  ...
                  <select class="form-control" id="List22" name="adress">
        ...
        <div class="box box-success">
          ...
          <div class="box-body no-padding">
            ...
            <div class="table-responsive">
              <table class="tableas table table-hover table-bordered" id="info-table">
                <thead>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="barcode/?id=<?= $data3['id']; ?>" target="_blank" class="btn btn-app">
