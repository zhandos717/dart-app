...
} elseif (!empty($_POST['adress']) and  $_POST['adress'] != '') {
  $sql  = ['status' => [10, 14, 15], 'region' => [$_POST['region']], 'adressfil' => [$_POST['adress']]];
}
        ...
        <table class="tableas table table-hover table-bordered" id="example1">
          ...
          <tbody>
            ...
            <tr class="col">
              ...
              <td>
                <a href="barcode/index.php?id=<?= $data['id']; ?>" class="btn btn-app" target="_blank">
...
<div class="col-md-12">
  <div class="box box-warning">
    ...
    <div class="box-body">
      <!-- /.search form -->
      <div class="table-responsive">
        <table class="tableas1 table table-hover" id="example2">
          <thead>
            <tr class="success">
              <th style="width: 5rem" class="text-center">№</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <?= $data['category']; ?>,
                <?= $data['tovarname']; ?> <?= $data['hdd']; ?>
                <?= $data['sostoyanie_bu']; ?> <?= $data['upakovka']; ?>
                <?= $data['ekran']; ?> <?= $data['korpus']; ?>
                SN: <?= $data['sn']; ?>, IMEI:<?= $data['imei']; ?>,
                <?= $data['complect']; ?> <?= $data['opisanie']; ?>

              </td>
              <td><?= $data['remontmessage']; ?> </td>
              <td> <?= $status; ?> </td>
              <td> <button data-articul="<?= $data['id']; ?>" data-status="10" class="btn btn-primary stt" title="Вернуть на склад"> <i class="fa  fa-rotate-left"></i> </button> </td>
            </tr>
            <?endif; } ?>
          </tbody>
          <tfoot>
