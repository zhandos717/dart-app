...
include "header.php"; 
include "menu.php"; 
    $result = R::findAll('sales',"data = :data AND region = :region AND adress = :adress  AND fromtovar = :fromtovar AND statustovar IS NULL",[':data'=>$data_z,':region'=> $region,':adress'=>$shop,':fromtovar'=>$fromtovar]);
