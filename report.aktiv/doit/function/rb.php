...
interface Adapter
{
	...
	/**
	 * Returns the original database resources. This is useful if you want to
...
class Finder
{
	...
	*/
	 ...
	 * query as its resources. Given an SQL query like 'SELECT movie.*, review.* FROM movie... JOIN review'
...
class Facade
{
	...
	*/
	 ...
	 * intercept static calls and routes them to the specified plugin.
	 *
