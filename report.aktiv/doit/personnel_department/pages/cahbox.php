...
$result = R::findAll('kassa', 'ORDER BY id DESC');
?>
                            ...
                            <table id="example1" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr class="<?= $color ?>">
                                            <td> 
                                                <button class="btn btn-warning update btn-block" data-id="<?= $key['id']; ?>" data-toggle="modal" data-target="#exampleModal"> 
                                                <?= $i++; ?>.</button>
                                            </td>
                                            <td class="text-center"><?= $key['codefil']; ?></td>
                                            <td><?= $key['region']; ?></td>
                                            <td><?= $key['filial']; ?></td>
                                            <td><?= $key['kassa']; ?></td>
                                            <td><?= $key['phone']; ?></td>
                                            <td><?= $key['company_id']; ?></td>
                                            <td><?= $key['statuskassa']; ?></td>
                                            <td><?= $key['login']; ?></td>
                                            <td><?= $key['status']; ?></td>
                                            <td><?= $key['text']; ?></td>
                                            <td><?= $key['swk']; ?></td>
...
<script>
    $(function() {
        $('.update').click(function(e) {
            var id = $(this).data('id');
            $.post('./function/edit_cashbox.php', {
                    id: id
                })
                .done(function(data) {
