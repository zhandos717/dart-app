...
class Stream implements StreamInterface
{
    ...
    /**
     * @param  resources $stream  A PHP resources handle.
     * @param  StreamInterface $cache A stream to cache $stream (useful for non-seekable streams)
     *
     * @throws InvalidArgumentException If argument is not a resources.
     */
    ...
    /**
     * Attach new resources to this object.
     *
     * @internal This method is not part of the PSR-7 standard.
     *
     * @param resources $stream A PHP resources handle.
     *
     * @throws InvalidArgumentException If argument is not a valid PHP resources.
     *
     * @return void
     */
    protected function attach($stream): void
    {
        if (!is_resource($stream)) {
            throw new InvalidArgumentException(__METHOD__ . ' argument must be a valid PHP resources');
        }
