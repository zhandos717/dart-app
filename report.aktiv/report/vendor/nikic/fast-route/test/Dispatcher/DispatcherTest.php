...
abstract class DispatcherTest extends TestCase
{
    ...
    /**
     * @expectedException \FastRoute\BadRouteException
     * @expectedExceptionMessage Static routes "/user/nikic" is shadowed by previously defined variable routes "/user/([^/]+)" for method "GET"
     */
    ...
    public function provideFoundDispatchCases()
    {
        ...
        $callback = function (RouteCollector $r) {
            $r->addRoute('GET', '/resources/123/456', 'handler0');
        };

        $method = 'GET';
        $uri = '/resources/123/456';
        $handler = 'handler0';
        $argDict = [];
        ...
        // 7 ----- Test GET method fallback on HEAD routes miss ------------------------------------>
        ...
        // 8 ----- Test GET method fallback on HEAD routes miss ------------------------------------>
        ...
        // 9 ----- Test GET method fallback on HEAD routes miss ------------------------------------>
        ...
        // 10 ---- Test existing HEAD routes used if available (no fallback) ----------------------->
    ...
    public function provideMethodNotAllowedDispatchCases()
    {
        ...
        $callback = function (RouteCollector $r) {
            $r->addRoute('GET', '/resources/123/456', 'handler0');
            $r->addRoute('POST', '/resources/123/456', 'handler1');
            $r->addRoute('PUT', '/resources/123/456', 'handler2');
            $r->addRoute('*', '/', 'handler3');
        };
