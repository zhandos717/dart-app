                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="border p-4 rounded">
                                <div class="form-body">
                                    <form class="row g-3" action='/authorization' method="post">
                                        <div class="col-12">
                                            <?= flash()->display(); ?>
                                            <label for="inputEmailAddress" class="form-label">LOGIN</label>
                                            <input type="text" required class="form-control" id="inputEmailAddress" name="login" placeholder="Email Address">
                                        </div>
                                        <div class="col-12">
