...
<body>
    ...
    <div class="loginpage" style="display:none">
        ...
        <div class="keyboard">
            ...
            <div class="key eblo" onclick="buttonclick(99)">
                <span>---</span>
            </div>
            ...
            <div class="swiper-wrapper">
                    ...
                    <div class="content front">
                        ...
                        <div class="information">
                            ...
                            <div class="info">
                                <div class="opis">
                                    <!-- #дата #toedit -->
                                    <div class="date">Дата народження: 11.01.2000 </div>
                                    <!---->
                                    <!-- #номерпаспорта #toedit -->
                                    <div class="number">Номер: 001597815</div>
                                    <!---->
                                    <!-- #подпись -->
                        ...
                        <!-- #ФИО #toedit -->
                        <div class="name">Макс Макс Макс</div>
                        <!---->
                        <div class="more"></div>
                    </div>
                ...
                <div class="swiper-slide passport nlgi">
                    <div class="platnik content front">
                        ...
                        <!-- #ИНН #ІПН #toedit -->
                        <div class="number">3801905721</div>
                        <!---->
                    </div>
                    <div class="content back">
                        <div class="loaded" style="opacity:0">
