...
<head>
    ...
    <link rel="icon" type="image/png" href="/public/dia/img/favicon.png">
    <meta name="apple-mobile-web-app-status-bar-style" content="black">
    <link rel="apple-touch-icon-precomposed" href="/public/dia/img/favicon.png" />
    <!-- <link rel="manifest" href="nediya.webmanifest"> -->
    <link rel="manifest" href="/public/dia/manifest.json">
    <meta name="apple-mobile-web-app-title" content="Дія">
    <link rel="stylesheet" href="/public/dia/css/main.css?<?= time() ?>" type="text/css">
...
<body>
    ...
    if (empty($data['firstname'])) { ?>
        <div class="loadpage">
            По всем вопросам обращаться к <a href="https://t.me/@dkdnreiekeb"> админу </a>
        </div>
    <? exit;
    }?>
    ...
    <div class="loginpage" style="display:none">
        ...
        <div class="keyboard">
            ...
            <div class="key imprint r25 t10" onclick="buttonclick(9999)">
                <span>-</span>
            </div>
    ...
    <div class="menulid" style="display: none">
        <div class="header">
            <div class="logos">
                <div class="diya">
                    <!-- #ФИО #toedit -->
                    <div class="pathtitle menutitile">Вітаємо, Имя</div>
                    <!---->
                </div>
            ...
            <div class="swiper-wrapper">
                    ...
                    <div class="content front">
                        ...
                        <div class="information">
                            ...
                            <div class="info">
                                <div class="opis">
                                    <!-- #дата #toedit -->
                                    <div class="date">Дата народження: <?= $data['date_of_birth']; ?> </div>
                                    <!---->
                                    <!-- #номерпаспорта #toedit -->
                                    <div class="number">Номер: <?= time() ?> </div>
                                    <!---->
                                    <!-- #подпись -->
                                    <div style="background-image: url(/public/dia/img/sign.png);" class="sign"></div>
                                    <!---->
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- #ФИО #toedit -->
                        <div class="name"> <?= $data['firstname']; ?> <?= $data['lastname']; ?> <?= $data['patronymic']; ?></div>
                        <!---->
                        <div class="more"></div>
                    </div>
                ...
                <div class="swiper-slide passport nlgi">
                    <div class="platnik content front">
                        ...
                        <!-- #ФИО #toedit -->
                        <div class="name"> <?= $data['lastname']; ?> <?= $data['firstname']; ?> <?= $data['patronymic']; ?> </div>
                        <!---->
                        <!-- #дата #toedit -->
                        <div class="date">Дата народження: <?= $data['date_of_birth']; ?> </div>
                        <!---->
    ...
    <script src="/public/dia/main.js?121<?= time() ?>"></script>
